...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    // The CenterGame is the server sided object which contains things like the
    // players lobby, it is used to hold objects on the web server for the
    // web checker users to view
    final CenterGame centerGame = new CenterGame();

    // inject the game center and freemarker engine into web server
    final WebServer webServer = new WebServer(templateEngine, gson, centerGame);
